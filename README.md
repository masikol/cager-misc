...
- ANI-taxon.sh (Help page is yet to be done): the script calculates Average Nucleotide Identities between query genomes and all type strain genomes of a given taxon;
...
- combinator-FQ2: a program for complete genome assembly facilitation. This program is now moved to the separate repository: [https://github.com/masikol/combinator-FQ2](https://github.com/masikol/combinator-FQ2);
...
- cigar_maplen: it was a script for manual inspection of structural variants, mainly for long reads. It prints which portion of a read is actually mapped, and which portions are clipped from each side. It is a Rust program now: [GitHub repo](https://github.com/masikol/cigar_collapser), [Rust crate](https://crates.io/crates/cigar_collapser);
